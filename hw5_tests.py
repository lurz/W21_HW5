...
class TestCard(unittest.TestCase):
    ...
    def test_q6(self):
        ...
        '''
        d = hw5_cards.Deck()
        l_before = len(d.cards)
        d.deal_card()
        l_after = len(d.cards)
        self.assertEqual(l_after, l_before-1)
        return l_after, l_before-1
    ...
    def test_q7(self):
        ...
        d.replace_card(c)
        l_after = len(d.cards)
        self.assertEqual(l_after, l_before + 1, l_first)
        return l_after, l_before + 1, l_first
    ...
    def test_q8(self):
        ...
        d.replace_card(c)
        l_after = len(d.cards)
        self.assertEqual(l_after, l_before)
